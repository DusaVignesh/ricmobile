            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.done) {
                if (snapshot.data!.docs.isNotEmpty) {
                  // The snapshot contains at least one document.
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      'vigneshdusa',
                                      style:
                                          TextStyle(color: Color(0xff98A6AD)),
                                    )
                                  ],
                                ),
                                SizedBox(
                                          ...
                                          for (int j = 0;
                                            ...
                                            for (int i = 0;
                                              ...
                                              CustomTextField(
                                                ...
                                                hinttext:
                                                    profile.schoolhinttext[j],
                                              ).textField()[i],
                                          for (int i = 0; i < 2; i++)
                                            ProfileDetail(
                                                    text: 'info',
                                                    iconData:
                                                        FlutterFontIcons.earth)
                                                .detail()[i],
                                          for (int j = 0;
                  ...
                  // The snapshot does not contain any documents.
                }
              }
